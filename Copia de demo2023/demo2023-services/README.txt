...
a persistence unit "demo2023-servicesPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/demo2023/services/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "demo2023-services/pom.xml":
...
artifact ("demo2023-services.war") is already built. You can build
